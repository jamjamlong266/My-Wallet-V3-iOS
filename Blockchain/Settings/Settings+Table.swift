...
extension SettingsTableViewController {
    ...
    func prepareRow(_ cell: UITableViewCell, _ format: SettingsCell) {
        ...
        case .email:
            getUserEmail() != nil &&
                WalletManager.sharedInstance().wallet.getEmailVerifiedStatus() == true ? formatDetailCell(true, cell) : formatDetailCell(false, cell)
        case .phoneNumber:
            WalletManager.sharedInstance().wallet.hasVerifiedMobileNumber() ? formatDetailCell(true, cell) : formatDetailCell(false, cell)
        case .currency:
            ...
            if self.allCurrencySymbolsDictionary[selectedCurrencyCode] == nil {
                updateAccountInfo()
            }
        ...
        case .twoFA:
            let authType = WalletManager.sharedInstance().wallet.getTwoStepType()
    ...
    override func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        headerLabel.textColor = Constants.Colors.ColorBrandPrimary
    ...
    override func tableView(_ tableView: UITableView, willSelectRowAt indexPath: IndexPath) -> IndexPath? {
        ...
        let hasLoadedAccountInfoDictionary: Bool = WalletManager.sharedInstance().wallet.hasLoadedAccountInfo ? true : false
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case sectionSecurity:
            if indexPath.row == securityTwoStep {
                ...
                showBackup()
                return
            } else if indexPath.row == Int(PINChangePIN) {
